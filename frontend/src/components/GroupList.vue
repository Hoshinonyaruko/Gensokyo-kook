<template>
  <q-table :rows="dataList" :columns="columns" :rows-per-page-options="[20, 50, 100]" row-key="id" selection="multiple"
    v-model:selected="selected" :row-class="rowClass">
    <template v-slot:top-right="props">
      <q-btn label="Select All" color="primary" @click="selectAll(props.rows)" />
    </template>
