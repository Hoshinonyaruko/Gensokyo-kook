<p align="center">
  <a href="https://www.github.com/hoshinonyaruko/gensokyo-kook">
    <img src="images/head.gif" width="200" height="200" alt="gensokyo-kook">
  </a>
</p>
...
_✨ 基于 [OneBot](https://github.com/howmanybots/onebot/blob/master/README.md) KOOK官方机器人Api Golang 原生实现 ✨_  
...
<p align="center">
  ...
  <img src="https://goreportcard.com/badge/github.com/hoshinonyaruko/gensokyo-kook" alt="GoReportCard">
  </a>
</p>
...
- [`hoshinonyaruko/gensokyo-discord`](https://github.com/Hoshinonyaruko/Gensokyo-discord): Discord-Gateway Onebotv11实现

## 引用
- [`idodo-golang-bot`](https://github.com/idodo/golang-bot): 本项目底层基于此项目,并进行了拓展.

## 兼容性
gensokyo-kook兼容 [OneBot-v11](https://github.com/botuniverse/onebot-11) ，并在其基础上做了一些扩展，详情请看 OneBot 的文档。

可将kook的websocket和api转换至onebotv11标准,比kookonebot字段更符合onebotv11,
...
- [`mnixry/nonebot-plugin-gocqhttp`](https://github.com/mnixry/nonebot-plugin-gocqhttp/): 本项目采用了mnixry编写的前端,并实现了与它对应的,基于kook的api的后端api.
- 感谢 Botmarket.cn 提供的平台支持,帮助早苗项目熬过低谷,度过难关.
...
- [x] 将服务器频道虚拟成群事件
- [x] 将私信虚拟成频道或群事件(更灵活)
- [x] 首个可以通过webui前端可视化管理机器人频道&发送信息的项目
- [x] 指令黑白名单
- [x] 可编辑的数据库
- [x] 支持array和信息段(支持连接array格式的onebot项目,比如trss)
- [x] 文字,图片,语音,视频,MD,支持多种类型发送
- [x] 支持频道&私聊
- [x] 完善的重连,健壮的连接能力.
- [x] 支持[CQ:markdown,data=] KMarkdown发送 (todo)
