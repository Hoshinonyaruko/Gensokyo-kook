...
func GetOb11Int32() bool {
	...
	if instance == nil {
		mylog.Println("Warning: instance is nil when trying to Ob11Int32 value.")
		return false
	}
	return instance.Settings.Ob11Int32
}
...
func GetIgnoreBotMessage() bool {
	...
	if instance == nil {
		mylog.Println("Warning: instance is nil when trying to IgnoreBotMessage value.")
		return false
	}
